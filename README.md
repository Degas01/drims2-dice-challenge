...
<video src="https://github.com/user-attachments/assets/5475ab0b-13d9-4061-bb03-9a3a752b28b3" width="600" controls muted loop></video>
</td></tr></table>
...
| `Package 'drims_dice_simulator' not found`, search path is only `/opt/ros/humble` | You are on the WSL host, not in the container. | Prompt should read `drims@`, not `username@`. `./connect.sh` first. |
